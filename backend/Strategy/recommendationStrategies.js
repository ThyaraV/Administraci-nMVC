...
class RecommendationStrategy {
  ...
  class OrderHistoryRecommendationStrategy extends RecommendationStrategy {
    async generateRecommendations(user) {
  ...
  class RatingBasedRecommendationStrategy extends RecommendationStrategy {
    async generateRecommendations(user) {
  ...
  export { OrderHistoryRecommendationStrategy, RatingBasedRecommendationStrategy };
